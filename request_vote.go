...
// Encodes the RequestVoteRequest to a buffer. Returns the nubmer of bytes
...
func newReqesutVoteResponse(term uint64, voteGranted bool) *RequestVoteResponse {
...
// Decodes the RequestVoteResponse from a buffer. Returns the nubmer of bytes read and
// any error that occurs.
